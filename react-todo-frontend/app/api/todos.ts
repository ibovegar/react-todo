...
export async function createTodo(todo: { title: string; description: string; tags?: TodoTag[] }): Promise<Todo> {
...
export async function updateTodo(id: string, fields: { title?: string; description?: string }): Promise<Todo> {
