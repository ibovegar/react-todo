...
export const ExpandModal = (props: ExpandModalProps) => {
  const { isClosing, animationStyle, modalRef, onAnimationEnd, onClose, children } = props

  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: stopPropagation to prevent click bubbling
    <div role="presentation" className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
      <button
        type="button"
